...
//todo
PUBLIC system_call sys_call_table[NR_SYS_CALL] = {sys_get_ticks, sys_delay_milli_seconds, sys_print_str, sys_p, sys_v}; //系统调用的函数
...
SEMAPHORE nr_readers = {2, 0, "nr_readers"}; //读上限人数信号量，控制读上限人数
...
SEMAPHORE cmutex = {SIZE, 0, "cmutex"};
SEMAPHORE mutex = {1, 0, "mutex"};            //控制对仓库的互斥访问
SEMAPHORE sget1 = {0, 0, "sget1"};            //控制C1去仓库消费P1生产的货物
SEMAPHORE sget2 = {0, 0, "sget2"};            //控制C2,C3去仓库消费P2生产的货物
